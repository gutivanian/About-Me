        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>Using the program since 2018</span>
                  </Row>
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use CMD for:</span>
                    <ul className='modal-list'>
                      <li>Running Commands</li>
                      <li>Batch Scripting</li>
                      <li>Automation</li>
                      <li>Modifying Environtment Variables</li>
                    </ul>
                  </Row>
                </Col>
            </Row>
