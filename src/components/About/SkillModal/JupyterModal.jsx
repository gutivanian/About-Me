...
import javascript from "../../../assets/Tool/jupyter.png"
import Carousel from 'react-bootstrap/Carousel'; 
import formvalidation from "../../../assets/project/js/form-validation.png"


function JupyterModal(props) {
  return (
        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use Jupyter for:</span>
                    <ul className='modal-list'>
                      <li>Interactive Computing</li>
                      <li>Program Learning and Research</li>
                      <li>Collaboration</li>
