...
import javascript from "../../../assets/Data Analyst/matplotlib.png"
import Carousel from 'react-bootstrap/Carousel'; 
import formvalidation from "../../../assets/project/js/form-validation.png"


function MatplotlibModal(props) {
  return (
        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>Using the program since 2022</span>
                  </Row>
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use matplotlib for:</span>
                    <ul className='modal-list'>
                      <li>Data Visualization</li>
                      <li>2D and 3D Visualization</li>
                      <li>Plot Animation</li>
                      <li>Multiple Subplot</li>
                    </ul>
                  </Row>
                </Col>
            </Row>
...
export default MatplotlibModal;
