        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use VSCode for:</span>
                    <ul className='modal-list'>
                      <li>Code Editing</li>
                      <li>Debugging</li>
                      <li>Running Integrated Terminal</li>
                    </ul>
                  </Row>
                </Col>
            </Row>
