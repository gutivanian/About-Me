        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>Using the program since 2016</span>
                  </Row>
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use Jitbit for:</span>
