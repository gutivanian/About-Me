        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use CSS for:</span>
                    <ul className='modal-list'>
                      <li>Styling Web Document</li>
                      <li>Designing Responsive Web</li>
                      <li>Creating Web Animation</li>
                    </ul>
                  </Row>
                </Col>
            </Row>
