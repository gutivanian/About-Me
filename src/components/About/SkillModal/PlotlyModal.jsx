...
import javascript from "../../../assets/Data Analyst/plotly.png"
import Carousel from 'react-bootstrap/Carousel'; 
import formvalidation from "../../../assets/project/js/form-validation.png"


function PlotlyModal(props) {
  return (
        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use Plotly for:</span>
                    <ul className='modal-list'>
                      <li>Data Visualization</li>
                      <li>Interactive Visualization</li>
                      <li>Dashboard Creation</li>
                      <li>Plotting Real-Time Data</li>
                    </ul>
                  </Row>
                </Col>
            </Row>
