...
import javascript from "../../../assets/Data Analyst/keras.png"
import Carousel from 'react-bootstrap/Carousel'; 
import formvalidation from "../../../assets/project/js/form-validation.png"


function KerasModal(props) {
  return (
        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use Keras for:</span>
                    <ul className='modal-list'>
                      <li>Model Prototyping</li>
                      <li>Neural Network Modeling</li>
                      <li>Deep Learning Backend</li>
                    </ul>
                  </Row>
                </Col>
            </Row>
