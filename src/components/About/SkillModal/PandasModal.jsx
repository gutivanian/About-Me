...
import javascript from "../../../assets/Data Analyst/pandas.png"
import Carousel from 'react-bootstrap/Carousel'; 
import formvalidation from "../../../assets/project/js/form-validation.png"


function PandasModal(props) {
  return (
        ...
        <Container>
            <Row className='skill-level'>
                ...
                <Col className="modal-container modal-text" sm = {8}>
                  ...
                  <br />
                  <Row>
                    <span className='skill-text'>Using the program since 2021</span>
                  </Row>
                  <br />
                  <Row>
                    <span className='skill-text'>I commonly use Pandas for:</span>
                    <ul className='modal-list'>
                      <li>Data Analysis</li>
                      <li>Data Manipulation</li>
                      <li>Dataframe Visualization</li>
